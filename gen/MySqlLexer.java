// Generated from /Users/zhuwenliang/dbproxy2/dbproxy/internal/protocol/mysql/internal/ast/MySqlLexer.g4 by ANTLR 4.13.1
...
public class MySqlLexer extends Lexer {
	...
	public static final int
		PROXY_HINT=1, SPACE=2, LINE_COMMENT=3, ADD=4, ALL=5, ALTER=6, ALWAYS=7, 
		ANALYZE=8, AND=9, ARRAY=10, AS=11, ASC=12, ATTRIBUTE=13, BEFORE=14, BETWEEN=15, 
		BOTH=16, BUCKETS=17, BY=18, CALL=19, CASCADE=20, CASE=21, CAST=22, CHANGE=23, 
		CHARACTER=24, CHECK=25, COLLATE=26, COLUMN=27, CONDITION=28, CONSTRAINT=29, 
		CONTINUE=30, CONVERT=31, CREATE=32, CROSS=33, CURRENT=34, CURRENT_ROLE=35, 
		CURRENT_USER=36, CURSOR=37, DATABASE=38, DATABASES=39, DECLARE=40, DEFAULT=41, 
		DELAYED=42, DELETE=43, DESC=44, DESCRIBE=45, DETERMINISTIC=46, DIAGNOSTICS=47, 
		DISTINCT=48, DISTINCTROW=49, DROP=50, EACH=51, ELSE=52, ELSEIF=53, EMPTY=54, 
		ENCLOSED=55, ENFORCED=56, ESCAPED=57, EXCEPT=58, EXISTS=59, EXIT=60, EXPLAIN=61, 
		FALSE=62, FETCH=63, FOR=64, FORCE=65, FOREIGN=66, FROM=67, FULLTEXT=68, 
		GENERATED=69, GET=70, GRANT=71, GROUP=72, HAVING=73, HIGH_PRIORITY=74, 
		HISTOGRAM=75, IF=76, IGNORE=77, IGNORED=78, IN=79, INDEX=80, INFILE=81, 
		INNER=82, INOUT=83, INSERT=84, INTERVAL=85, INTO=86, IS=87, ITERATE=88, 
		JOIN=89, KEY=90, KEYS=91, KILL=92, LATERAL=93, LEADING=94, LEAVE=95, LEFT=96, 
		LIKE=97, LIMIT=98, LINEAR=99, LINES=100, LOAD=101, LOCK=102, LOCKED=103, 
		LOOP=104, LOW_PRIORITY=105, MASTER_BIND=106, MASTER_SSL_VERIFY_SERVER_CERT=107, 
		MATCH=108, MAXVALUE=109, MINVALUE=110, MODIFIES=111, NATURAL=112, NOT=113, 
		NO_WRITE_TO_BINLOG=114, NULL_LITERAL=115, NUMBER=116, ON=117, OPTIMIZE=118, 
		OPTION=119, OPTIONAL=120, OPTIONALLY=121, OR=122, ORDER=123, OUT=124, 
		OUTER=125, OUTFILE=126, OVER=127, PARTITION=128, PRIMARY=129, PROCEDURE=130, 
		PURGE=131, RANGE=132, READ=133, READS=134, REFERENCES=135, REGEXP=136, 
		RELEASE=137, RENAME=138, REPEAT=139, REPLACE=140, REQUIRE=141, RESIGNAL=142, 
		RESTRICT=143, RETAIN=144, RETURN=145, REVOKE=146, RIGHT=147, RLIKE=148, 
		SCHEMA=149, SCHEMAS=150, SELECT=151, SET=152, SEPARATOR=153, SHOW=154, 
		SIGNAL=155, SKIP_=156, SKIP_QUERY_REWRITE=157, SPATIAL=158, SQL=159, SQLEXCEPTION=160, 
		SQLSTATE=161, SQLWARNING=162, SQL_BIG_RESULT=163, SQL_CALC_FOUND_ROWS=164, 
		SQL_SMALL_RESULT=165, SSL=166, STACKED=167, STARTING=168, STATEMENT=169, 
		STRAIGHT_JOIN=170, TABLE=171, TERMINATED=172, THEN=173, TO=174, TRAILING=175, 
		TRIGGER=176, TRUE=177, UNDO=178, UNION=179, UNIQUE=180, UNLOCK=181, UNSIGNED=182, 
		UPDATE=183, USAGE=184, USE=185, USING=186, VALUES=187, WHEN=188, WHERE=189, 
		WHILE=190, WITH=191, WRITE=192, XOR=193, ZEROFILL=194, TINYINT=195, SMALLINT=196, 
		MEDIUMINT=197, MIDDLEINT=198, INT=199, INT1=200, INT2=201, INT3=202, INT4=203, 
		INT8=204, INTEGER=205, BIGINT=206, REAL=207, DOUBLE=208, PRECISION=209, 
		FLOAT=210, FLOAT4=211, FLOAT8=212, DECIMAL=213, DEC=214, NUMERIC=215, 
		DATE=216, TIME=217, TIMESTAMP=218, DATETIME=219, YEAR=220, CHAR=221, VARCHAR=222, 
		NVARCHAR=223, NATIONAL=224, BINARY=225, VARBINARY=226, TINYBLOB=227, BLOB=228, 
		MEDIUMBLOB=229, LONG=230, LONGBLOB=231, TINYTEXT=232, TEXT=233, MEDIUMTEXT=234, 
		LONGTEXT=235, ENUM=236, VARYING=237, SERIAL=238, YEAR_MONTH=239, DAY_HOUR=240, 
		DAY_MINUTE=241, DAY_SECOND=242, HOUR_MINUTE=243, HOUR_SECOND=244, MINUTE_SECOND=245, 
		SECOND_MICROSECOND=246, MINUTE_MICROSECOND=247, HOUR_MICROSECOND=248, 
		DAY_MICROSECOND=249, JSON_ARRAY=250, JSON_ARRAYAGG=251, JSON_ARRAY_APPEND=252, 
		JSON_ARRAY_INSERT=253, JSON_CONTAINS=254, JSON_CONTAINS_PATH=255, JSON_DEPTH=256, 
		JSON_EXTRACT=257, JSON_INSERT=258, JSON_KEYS=259, JSON_LENGTH=260, JSON_MERGE=261, 
		JSON_MERGE_PATCH=262, JSON_MERGE_PRESERVE=263, JSON_OBJECT=264, JSON_OBJECTAGG=265, 
		JSON_OVERLAPS=266, JSON_PRETTY=267, JSON_QUOTE=268, JSON_REMOVE=269, JSON_REPLACE=270, 
		JSON_SCHEMA_VALID=271, JSON_SCHEMA_VALIDATION_REPORT=272, JSON_SEARCH=273, 
		JSON_SET=274, JSON_STORAGE_FREE=275, JSON_STORAGE_SIZE=276, JSON_TABLE=277, 
		JSON_TYPE=278, JSON_UNQUOTE=279, JSON_VALID=280, JSON_VALUE=281, NESTED=282, 
		ORDINALITY=283, PATH=284, AVG=285, BIT_AND=286, BIT_OR=287, BIT_XOR=288, 
		COUNT=289, CUME_DIST=290, DENSE_RANK=291, FIRST_VALUE=292, GROUP_CONCAT=293, 
		LAG=294, LAST_VALUE=295, LEAD=296, MAX=297, MIN=298, NTILE=299, NTH_VALUE=300, 
		PERCENT_RANK=301, RANK=302, ROW_NUMBER=303, STD=304, STDDEV=305, STDDEV_POP=306, 
		STDDEV_SAMP=307, SUM=308, VAR_POP=309, VAR_SAMP=310, VARIANCE=311, CURRENT_DATE=312, 
		CURRENT_TIME=313, CURRENT_TIMESTAMP=314, LOCALTIME=315, CURDATE=316, CURTIME=317, 
		DATE_ADD=318, DATE_SUB=319, EXTRACT=320, LOCALTIMESTAMP=321, NOW=322, 
		POSITION=323, SUBSTR=324, SUBSTRING=325, SYSDATE=326, TRIM=327, UTC_DATE=328, 
		UTC_TIME=329, UTC_TIMESTAMP=330, ACCOUNT=331, ACTION=332, AFTER=333, AGGREGATE=334, 
		...
		HOST_IP_ADDRESS=1157, LOCAL_ID=1158, GLOBAL_ID=1159, ERROR_RECONGNIGION=1160;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "PROXY_HINT", "SPACE", "LINE_COMMENT", "ADD", "ALL", "ALTER", "ALWAYS", 
