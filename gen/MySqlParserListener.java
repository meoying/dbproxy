// Generated from /Users/zhuyu/dbproxy/internal/protocol/mysql/internal/ast/MySqlParser.g4 by ANTLR 4.13.1
...
public interface MySqlParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MySqlParser#proxyHint}.
	 * @param ctx the parse tree
	 */
	void enterProxyHint(MySqlParser.ProxyHintContext ctx);
	/**
	 * Exit a parse tree produced by {@link MySqlParser#proxyHint}.
	 * @param ctx the parse tree
	 */
	void exitProxyHint(MySqlParser.ProxyHintContext ctx);
	/**
	 * Enter a parse tree produced by {@link MySqlParser#annotation}.
	 * @param ctx the parse tree
	 */
	void enterAnnotation(MySqlParser.AnnotationContext ctx);
	/**
	 * Exit a parse tree produced by {@link MySqlParser#annotation}.
	 * @param ctx the parse tree
	 */
	void exitAnnotation(MySqlParser.AnnotationContext ctx);
	/**
	 * Enter a parse tree produced by {@link MySqlParser#key}.
	 * @param ctx the parse tree
	 */
	void enterKey(MySqlParser.KeyContext ctx);
	/**
	 * Exit a parse tree produced by {@link MySqlParser#key}.
	 * @param ctx the parse tree
	 */
	void exitKey(MySqlParser.KeyContext ctx);
	/**
