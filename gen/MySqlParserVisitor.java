...
public interface MySqlParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link MySqlParser#proxyHint}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitProxyHint(MySqlParser.ProxyHintContext ctx);
	/**
	 * Visit a parse tree produced by {@link MySqlParser#annotation}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAnnotation(MySqlParser.AnnotationContext ctx);
	/**
	 * Visit a parse tree produced by {@link MySqlParser#key}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitKey(MySqlParser.KeyContext ctx);
	/**
