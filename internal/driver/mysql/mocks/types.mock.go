...
//
//	mockgen -source=./types.go -destination=mocks/types.mock.go -package=mocks -typed
//
...
// AllLastInsertIds mocks base method.
func (m *MockResult) AllLastInsertIds() []int64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AllLastInsertIds")
	ret0, _ := ret[0].([]int64)
	return ret0
}

// AllLastInsertIds indicates an expected call of AllLastInsertIds.
func (mr *MockResultMockRecorder) AllLastInsertIds() *ResultAllLastInsertIdsCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AllLastInsertIds", reflect.TypeOf((*MockResult)(nil).AllLastInsertIds))
	return &ResultAllLastInsertIdsCall{Call: call}
}

// ResultAllLastInsertIdsCall wrap *gomock.Call
type ResultAllLastInsertIdsCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *ResultAllLastInsertIdsCall) Return(arg0 []int64) *ResultAllLastInsertIdsCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *ResultAllLastInsertIdsCall) Do(f func() []int64) *ResultAllLastInsertIdsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *ResultAllLastInsertIdsCall) DoAndReturn(f func() []int64) *ResultAllLastInsertIdsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// AllRowsAffected mocks base method.
func (m *MockResult) AllRowsAffected() []int64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AllRowsAffected")
	ret0, _ := ret[0].([]int64)
	return ret0
}

// AllRowsAffected indicates an expected call of AllRowsAffected.
func (mr *MockResultMockRecorder) AllRowsAffected() *ResultAllRowsAffectedCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AllRowsAffected", reflect.TypeOf((*MockResult)(nil).AllRowsAffected))
	return &ResultAllRowsAffectedCall{Call: call}
}

// ResultAllRowsAffectedCall wrap *gomock.Call
type ResultAllRowsAffectedCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *ResultAllRowsAffectedCall) Return(arg0 []int64) *ResultAllRowsAffectedCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *ResultAllRowsAffectedCall) Do(f func() []int64) *ResultAllRowsAffectedCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *ResultAllRowsAffectedCall) DoAndReturn(f func() []int64) *ResultAllRowsAffectedCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
