...
func (p *BaseBuilder) buildResultSetRespPackets(cols []ColumnType, rows [][]any, serverStatus SeverStatus, charset uint32, buildFunc buildResultsetRowRespPacket) ([][]byte, error) {
